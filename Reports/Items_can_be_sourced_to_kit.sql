...
Select
	s10.kit_product_number,
	s10.kit_edi,
	s10.kit_description,
	s10.serial_number,
	s10.kit_bin,
	s10.component_product_number,
	s10.component_description,
	case
		when s10.qty_in_kit = 0 then 'Not in Kit' else 'In Kit'
	end as is_in_kit,
	s10.qty_avail_sh,
	s10.component_bin,
	s10.qty_avail_e01,
	s10.Pieces_missing as Pieces_missing_in_serial
	
From
	s10
where
	s10.pieces_missing != 0
	and s10.component_bin is not null
	and s10.qty_avail_sh > 0
	and s10.qty_in_kit = 0
