...
SELECT
	p.product_number,
	p.edi_number,
	sum(s.quantity_on_hand) AS qoh_in_whse
FROM
	sms.stock s
...
SELECT DISTINCT
	...
	s1.bin,
	s5.kit_qoh,
	s4.qoh_in_whse as Loose_in_Warehouse,
	s0.loose_qoh as Loose_in_Enviorment,
...
FROM
	kit_par s0
		...
		LEFT JOIN loose_in_whse s4 ON s1.product_number = s4.product_number
